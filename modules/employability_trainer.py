...
from employability_transform import (
...
def get_model(hyperparameters, show_summary=True):
    ...
    deep = tf.keras.layers.Dense(hyperparameters['dense_1_units'], activation="relu")(concatenate)
    deep = tf.keras.layers.Dense(hyperparameters['dense_2_units'], activation="relu")(deep)
    deep = tf.keras.layers.Dense(hyperparameters['dense_3_units'], activation="relu")(deep)
